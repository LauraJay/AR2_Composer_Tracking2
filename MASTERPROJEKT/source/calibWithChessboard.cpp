...
static bool runAndSave(const string& outputFilename,
	...
	Mat& distCoeffs, Mat& R, std::vector<double>& tvec, vector<Mat>& rvecs, vector<Mat>&tvecs,
	bool writeExtrinsics, bool writePoints)
{
	...
	bool ok = runCalibration(imagePoints, imageSize, boardSize, patternType, squareSize,
		aspectRatio, flags, cameraMatrix, distCoeffs,R, tvec,
		...
		if (view.empty())
		{
			if (imagePoints.size() > 0)
				runAndSave(outputFilename, imagePoints, imageSize,
					...
					flags, cameraMatrix, distCoeffs, R, tvec, rvecs,tvecs,
